...
namespace NetExtend.Components
{
    public class ProgressDialog : IDisposable
    {
        private readonly BackgroundWorker worker = new BackgroundWorker();
        private readonly dialogForm dialog = new dialogForm();
        ...
        public int Max
        {
            get { return dialog.progressBar.Maximum; }
            set { dialog.progressBar.Maximum = value; }
        }
